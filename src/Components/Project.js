...
function Project({ title, image, description, techstack, previewLink, githubLink }) {
  return (
    <article className="flex flex-col h-66 mt-6 sm:mb-8  rounded-xl overflow-hidden shadow-xl shadow-slate-300 dark:shadow-slate-900">
      ...
      <div className="dark:bg-dark-card p-4 flex flex-col flex-grow">
        ...
        {/* Description */}
        {description && (
          <p className="text-content pt-4 font-light line-clamp-4">
            {description}
          </p>
        )}
        ...
        {/* Links section only if preview or GitHub exists */}
